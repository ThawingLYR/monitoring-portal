...
st.markdown(
    """
    **Under Development** This page will show historic and current weather observables. The weather stations are those in the MET database plus private Netatmo weather stations. In the meantime, data from the weather stations in the MET database can be retrieved from https://frost.met.no/, while https://seklima.met.no/ can also be used to visualize data and retrieve station information.
    """
)
