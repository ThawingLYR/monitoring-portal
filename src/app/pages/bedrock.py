...
st.markdown(
    ...
    Note that more data points are coming in the map for the "Shallow (<5 m) boreholes not reaching bedrock" and "Deep (>5 m) boreholes reaching bedrock".
