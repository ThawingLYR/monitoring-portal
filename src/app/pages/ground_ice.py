...
st.markdown(
    ...
    The developed top permafrost ice map can be utilised in the work to improve the resilience towards climate change and geohazards in Longyearbyen. 
